...
<head>
    ...
    <style>
        @page {
            ...
            /* background-image: url("{{ public_path('letterheads/'.$clinic->letterhead_image) }}");
            background-size: cover;
                background-repeat: no-repeat; */
                /* padding-top: {{ $clinic->pdf_margin_top ?? 40 }}px;
            padding-bottom: {{ $clinic->pdf_margin_bottom ?? 40 }}px; */
        }
        body {
            ...
            color: #000;
            margin: 0px;
            /* margin-top: {{ $clinic->pdf_margin_top ?? 40 }}px;
            margin-bottom: {{ $clinic->pdf_margin_bottom ?? 40 }}px;
            margin-left: {{ $clinic->pdf_margin_left ?? 40 }}px;
            margin-right: {{ $clinic->pdf_margin_right ?? 40 }}px; */
/* 
            background-image: url("{{ public_path('letterheads/'.$clinic->letterhead_image) }}");
            background-repeat: no-repeat;
            background-size: cover;
        ...
        .myBody{
            margin-top: {{ $clinic->pdf_margin_top ?? 40 }}px;
            margin-bottom: {{ $clinic->pdf_margin_bottom ?? 80 }}px;
...
<body>
    @if(!empty($clinic->letterhead_image))
        <div style="" class="letterhead">
            <img src="{{ public_path('letterheads/'.$clinic->letterhead_image) }}" style="width:100%;">
        </div>
    @endif
